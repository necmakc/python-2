# ------------------------------------------------------------------------------------------------------------
# Задача 1:  Винни-Пух попросил Вас посмотреть, есть ли в его стихах ритм. Поскольку разобраться в его
...
def my_func(text):
    ...
    for word in res:
        ...
        for i in word:
            if i in vowels:
                count_vowels += 1
        list_sum.append(count_vowels)
    return len(list_sum) == list_sum.count(list_sum[0])
...
if my_func(text):
    ...
    print('Пам парам')
# ------------------------------------------------------------------------------------------------------------
# Задача 2: Напишите функцию print_operation_table(operation, num_rows=6, num_columns=6), которая принимает
...
def print_operation_table(operation, num_rows=6, num_columns=6):
    list_1 = [[operation(i, j) for j in range(1, num_columns + 1)]
